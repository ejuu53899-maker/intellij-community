...
- [x] **Configurable Bridge Ports:** Partially addressed via `.mcp.json` environment configuration.
...
- [x] **Hostinger VPS Deployment:** Created `deploy-hostinger.sh` for remote VPS deployment.
